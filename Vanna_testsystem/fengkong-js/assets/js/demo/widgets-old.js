...
var demoHighChartsAdvanced = function(data) {
    ...
    $.each(data.dates, function(k, v) {
        dailyPnlsList.push([v, data.dailyPnls[k]])
    })
    // High Chart Data Set 
    var detailChart;
...
return {
    init: function() {
        ...
        if ($('#high-datamap').length) {
            $.ajax({
                method: "POST",
                // url: "http://192.168.0.189:8080/risk-control/api/portfolio/listFutureSeodReport",
                ...
                //假数据START
                // var datesArray = [],
                //     initialDate = 1504195200000;
                // for(var i = 0; i < 1095; i++) {
                //     datesArray.push(initialDate);
                //     initialDate += 86400000;
                // }
                // res = {

                //     result: {
                //         // dates: [1504195200000, 1504281600000,1504368000000,1504454400000],//时间戳*1000
                //         dates: datesArray, //时间戳*1000
