...
function renderApp() {
    ...
    new Vue({
        ...
        mounted: function() {
            ...
            $.ajax({
                method: "POST",
                   url: "http://192.168.0.192:8080/risk-control/api/portfolio/listFutureSeodSector",
//              url: "http://www.easy-mock.com/mock/59ce5d28c5c4302238f59cb1/risk-control/api/portfolio/listFutureSeodSector",
        ...
        methods: {
            datechanged: function(dateTxt) {
                ...
                this.getAndRenderFutureSeodList(this.selectedDate)
            },
            sectorchanged: function() {
                this.getAndRenderSectorReport(this.curSectorId);
            ...
            getAndRenderSectorReport: function(sectorid, token) {
                if ($('#high-datamap').length) {
                    $.ajax({
                        method: "POST",
                           url: "http://192.168.0.192:8080/risk-control/api/portfolio/listFutureSeodReport",
...
//                      }
            ...
            getAndRenderFutureSeodList: function(dateTxt){
                ...
                $.ajax({
                    method: "POST",
                       url: "http://192.168.0.192:8080/risk-control/api/portfolio/listFutureSeod",
